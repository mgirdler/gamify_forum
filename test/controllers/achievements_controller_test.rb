...
class AchievementsControllerTest < ActionController::TestCase
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post :create, achievement: { achievement_description: @achievement.achievement_description, achievement_name: @achievement.achievement_name }
    end
  ...
  test "should update achievement" do
    patch :update, id: @achievement, achievement: { achievement_description: @achievement.achievement_description, achievement_name: @achievement.achievement_name }
    assert_redirected_to achievement_path(assigns(:achievement))
  end
